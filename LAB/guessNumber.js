...
function checkGuess() {
  ...
  if (userGuess === secretNumber) {
    // Output message for correct guess
    resultElement.innerHTML = "<p>Congratulations! You guessed the correct number!</p>";
    
    // Display picture2 and play music2
    showImageAndPlaySound("picture2.jpeg", "music2.mp3");

    // Generate a new random number for the next round
    secretNumber = generateRandomNumber();
  } else {
    // Output message for incorrect guess
    resultElement.innerHTML = "<p>Sorry, try again!</p>";
    
    // Display picture1 and play music1
